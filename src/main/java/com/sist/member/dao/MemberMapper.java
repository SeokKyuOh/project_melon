...
public interface MemberMapper {
	...
	//로그인전체정보-yk
		...
		@Select("SELECT question_title, question_regdate FROM question q WHERE q.member_id=#{member_id}")
		...
		@Select("SELECT d.download_name, bd.buy_download_start, bd.buy_download_end FROM buy_download bd, download d WHERE bd.member_id=#{member_id} and d.download_id = bd.download_id ORDER BY bd.buy_download_start ASC")
